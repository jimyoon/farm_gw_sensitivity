...
from idaes.core.util.scaling import (scale_constraints, ScalingBasis, calculate_scaling_factors)
...
no_of_years = 1  # The number of years (annual timesteps) to run simulation
...
# def farm_gw_model(nir_mult):  # currently only picking a couple variables to test (applied uniformly across all crops)
nir_mult = 0.8093750000000001
